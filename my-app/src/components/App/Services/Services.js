      ...
      <ScrollableAnchor id={"services"}>
        <div className="ServicesBg">
          ...
          <div className="servicesList">
            <div className="servicesBlock">
              ...
              <div className="servicesContainer">
                ...
                <ul>
                  ...
                  <li>Спил, обрезка, пересадка деревьев и кустарников, покос травы</li>
            ...
            <div className="servicesBlock">
              <div className="servicesContainer">
                <h3>Грузоперевозки/Вывоз в утилицацию</h3>
                <ul>
              ...
              <div className="servicesContainer">
                ...
                <ul>
                  <li>
                    ...
                    тренажеров, сейфов и других тяжелых и крупогабаритных единиц
                  </li>
                </ul>
              </div>
            </div>
